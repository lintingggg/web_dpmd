    ...
    <main class="container page-content">
        ...
        <div class="py-2">
            ...
            <p class="text-left text-slate-700 mb-10 text-lg leading-relaxed">
                Kode etik dan standar pelayanan operasional Dinas Pemberdayaan Masyarakat dan Desa Kabupaten Bangkalan.
            </p>

            <!-- Content Block -->
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 md:p-12 mb-16">
                <!-- Teks Kode Etik -->
                <div class="prose max-w-none text-slate-700 leading-relaxed text-lg prose-li:my-2 prose-ul:list-disc prose-ol:list-decimal prose-ul:pl-6 prose-ol:pl-6 text-left mb-10" v-if="props.profil.kode_etik_teks" v-html="props.profil.kode_etik_teks"></div>
                <div class="text-slate-600 text-lg text-left mb-10" v-else>
                    <p>(Data Kode Etik Pelayanan Belum Tersedia)</p>
                </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden min-h-[600px] flex flex-col">
                        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="font-semibold text-gray-700 text-sm">PDF Kode Etik Pelayanan</span>
                            </div>
                            <a :href="'/storage/' + props.profil.kode_etik_dokumen" target="_blank" rel="noopener noreferrer" class="text-sm font-medium text-blue-600 hover:text-blue-800 transition-colors">Buka di Tab Baru</a>
                        </div>
                        <div class="flex-grow bg-gray-100 relative" style="min-height: 600px;">
                            <iframe 
                                :src="'/storage/' + props.profil.kode_etik_dokumen" 
