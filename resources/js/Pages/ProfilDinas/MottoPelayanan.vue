...
const profile = {
    ...
    motto: "Melayani Dengan Integritas, Membangun Desa Dengan Hati",
...
<template>
    ...
    <main class="container">
        ...
        <section class="motto-box">

            <span class="motto-label">
        ...
        <section class="content-card">
            ...
            <div v-html="profile.content"></div>
