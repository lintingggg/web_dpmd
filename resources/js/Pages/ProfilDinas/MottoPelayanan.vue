...
<template>
    <Head title="Motto Pelayanan - DPMD Bangkalan" />
    ...
    <main class="container page-content">
        ...
        <div class="py-2">
            ...
            <p class="text-left text-slate-700 mb-10 text-lg leading-relaxed">
                Semboyan semangat melayani dari Dinas Pemberdayaan Masyarakat dan Desa Kabupaten Bangkalan.
            </p>

            <!-- Content Block -->
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 md:p-12 mb-16">
                <div class="prose max-w-none text-slate-700 leading-relaxed text-lg prose-li:my-2 prose-ul:list-disc prose-ol:list-decimal prose-ul:pl-6 prose-ol:pl-6 text-left" v-if="props.profil.motto_teks" v-html="props.profil.motto_teks"></div>
                <div class="text-slate-600 text-lg text-left" v-else>
                    <p>(Data Motto Pelayanan Belum Tersedia)</p>
                </div>
            </div>
