        ...
        <div class="w-full">
            ...
            <div v-show="activeTab === 'kontak'" class="bg-white rounded-[24px] shadow-[0_4px_20px_rgba(16,57,115,0.06)] border border-[#dbe6f7] p-8">
                <div class="flex items-center gap-3 mb-6 pb-6 border-b border-[#dbe6f7]">
                    <div class="w-10 h-10 rounded-xl bg-[#eaf1fb] flex items-center justify-center flex-shrink-0">
                        <span class="material-symbols-outlined text-slate-700 text-[22px]">contact_phone</span>
                    </div>
                    <div>
                        <h3 class="text-[18px] font-bold text-slate-900">Informasi Kontak</h3>
                        <p class="text-[13px] font-medium text-slate-500">Alamat, nomor telepon, dan jam layanan</p>
                    </div>
                </div>
                        ...
                        <div>
                            ...
                            <div class="bg-[#f5f8fd] border border-[#dbe6f7] rounded-xl p-3 focus-within:border-[#1356a0] focus-within:bg-white transition-colors">
                                ...
                                <div class="flex items-center gap-2 mb-3">
                                    ...
                                    <select v-model="hariBuka" class="flex-1 bg-white border border-[#dbe6f7] text-slate-900 text-[13px] font-medium rounded-lg px-2 py-1.5 focus:ring-[#1356a0]">
                                        <option v-for="hari in hariOptions" :key="hari" :value="hari">{{ hari }}</option>
                                    </select>
                                    <span class="text-slate-500 font-bold">-</span>
                                    <select v-model="hariTutup" class="flex-1 bg-white border border-[#dbe6f7] text-slate-900 text-[13px] font-medium rounded-lg px-2 py-1.5 focus:ring-[#1356a0]">
                                        <option v-for="hari in hariOptions" :key="hari" :value="hari">{{ hari }}</option>
                                    </select>
                                </div>
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <input type="time" v-model="jamBuka" class="flex-1 bg-white border border-[#dbe6f7] text-slate-900 text-[13px] font-medium rounded-lg px-2 py-1.5 focus:ring-[#1356a0]" />
                                    <span class="text-slate-500 font-bold">-</span>
            ...
            <div v-show="activeTab === 'sosmed'" class="bg-white rounded-[24px] shadow-[0_4px_20px_rgba(16,57,115,0.06)] border border-[#dbe6f7] p-8">
                <div class="flex items-center gap-3 mb-6 pb-6 border-b border-[#dbe6f7]">
                    ...
                    <div>
                        <h3 class="text-[18px] font-bold text-slate-900">Tautan Profil Media Sosial</h3>
                        <p class="text-[13px] font-medium text-slate-500">Tautan ke jejaring sosial resmi DPMD</p>
                    </div>
                </div>
            ...
            <div v-show="activeTab === 'embed'" class="bg-white rounded-[24px] shadow-[0_4px_20px_rgba(16,57,115,0.06)] border border-[#dbe6f7] p-8">
                <div class="flex items-center gap-3 mb-8 pb-6 border-b border-[#dbe6f7]">
                    ...
                    <div>
                        <h3 class="text-[18px] font-bold text-slate-900">Pengaturan Widget Beranda (Embed)</h3>
                        <p class="text-[13px] font-medium text-slate-500">Kode Embed Iframe untuk menampilkan postingan media sosial di Halaman Utama.</p>
                    </div>
                </div>
